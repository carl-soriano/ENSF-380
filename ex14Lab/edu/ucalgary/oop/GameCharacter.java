...
abstract class GameCharacter {
    ...
    private void validateAndRecordAttackPriority(int attackPriority) throws IllegalArgumentException{
        if(attackPriorities.contains(Integer.valueOf(attackPriority))){
            throw new IllegalArgumentException();
        } 
        else {
            attackPriorities.add(Integer.valueOf(attackPriority));
        }
    }
